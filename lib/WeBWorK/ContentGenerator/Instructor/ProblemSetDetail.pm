...
use constant SET_FIELD_ORDER => [qw(open_date due_date answer_date visible enable_reduced_scoring restricted_release restricted_status relax_restricted_release restrict_ip relax_restrict_ip assignment_type)];
